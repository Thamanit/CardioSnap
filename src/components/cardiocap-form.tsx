...
const formSchema = z.object({
  ...
  ecgRhythm: z
    ...
    .optional(),
  ecgConduction: z
    .enum(["normal", "prolonged_pr", "bundle_branch_block"])
    .optional(),
  bundleBranchBlockDetail: z.string().optional(),
  sttChanges: z
    .enum(["normal", "st_depression", "st_elevation", "t_wave_inversion"])
    .optional(),
  ...
  murmurPosition: z
    .enum(["aortic", "pulmonic", "tricuspid", "mitral"])
    .optional(),
  extraHeartSounds: z.array(z.string()).optional(),
  rhythmCharacteristics: z
    .enum(["regular", "irregular", "variable_intensity"])
    .optional(),
...
const ResultDisplayItem: React.FC<{
  ...
  sub?: boolean;
}> = ({ label, value, sub = false }) => (
  <div
    className={`flex justify-between items-start text-sm ${sub ? "pl-4" : ""}`}
  >
...
export default function CardioCapForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      try {
        ecgLead1 =
          typeof ecgLead1 === "string" ? JSON.parse(ecgLead1) : ecgLead1;
        ecgLead2 =
          typeof ecgLead2 === "string" ? JSON.parse(ecgLead2) : ecgLead2;
        ecgLead3 =
          typeof ecgLead3 === "string" ? JSON.parse(ecgLead3) : ecgLead3;
      } catch {
        ecgLead1 =
          typeof ecgLead1 === "string" ? parseFloat(ecgLead1) : ecgLead1;
        ecgLead2 =
          typeof ecgLead2 === "string" ? parseFloat(ecgLead2) : ecgLead2;
        ecgLead3 =
      ...
      try {
        murmurAudioData =
          typeof murmurAudioData === "string" && murmurAudioData
            ? JSON.parse(murmurAudioData)
            : murmurAudioData;
      } catch {
            ...
            <CardContent className="space-y-8">
              ...
              <section className="space-y-4">
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            <FormItem className="flex items-center space-x-2 space-y-0">
                              ...
                              <FormLabel className="font-normal">
                                {t.patient.examinerProfessional}
                              </FormLabel>
                            </FormItem>
                          </RadioGroup>
                        </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder={t.patient.examinerPlaceholder}
                              {...field}
                            />
                          </FormControl>
                        </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t.patient.hnPlaceholder}
                            {...field}
                          />
                        </FormControl>
                      </FormItem>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t.patient.examDate}</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t.patient.examTime}</FormLabel>
                        <FormControl>
              ...
              <section className="space-y-4">
                      ...
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t.ecg.rhythmPlaceholder}
                              />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            <SelectItem value="sinus_rhythm">
                              {t.ecg.rhythmOptions.sinus_rhythm}
                            </SelectItem>
                            <SelectItem value="sinus_tachycardia">
                              {t.ecg.rhythmOptions.sinus_tachycardia}
                            </SelectItem>
                            <SelectItem value="sinus_bradycardia">
                              {t.ecg.rhythmOptions.sinus_bradycardia}
                            </SelectItem>
                            <SelectItem value="atrial_fibrillation">
                              {t.ecg.rhythmOptions.atrial_fibrillation}
                            </SelectItem>
                            <SelectItem value="irregular_rhythm">
                              {t.ecg.rhythmOptions.irregular_rhythm}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </FormItem>
                      ...
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t.ecg.conductionPlaceholder}
                              />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            <SelectItem value="normal">
                              {t.ecg.conductionOptions.normal}
                            </SelectItem>
                            <SelectItem value="prolonged_pr">
                              {t.ecg.conductionOptions.prolonged_pr}
                            </SelectItem>
                            <SelectItem value="bundle_branch_block">
                              {t.ecg.conductionOptions.bundle_branch_block}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </FormItem>
                ...
                {conduction === "bundle_branch_block" && (
                  <FormField
                    control={form.control}
                    name="bundleBranchBlockDetail"
                    render={({ field }) => (
                      <FormItem className="pl-6">
                        <FormLabel>{t.ecg.bundleBranchBlockDetail}</FormLabel>
                        <FormControl>
                          <Input
                            placeholder={
                              t.ecg.bundleBranchBlockDetailPlaceholder
                            }
                            {...field}
                          />
                        </FormControl>
                      ...
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t.ecg.sttChangesPlaceholder}
                              />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            <SelectItem value="normal">
                              {t.ecg.sttChangesOptions.normal}
                            </SelectItem>
                            <SelectItem value="st_depression">
                              {t.ecg.sttChangesOptions.st_depression}
                            </SelectItem>
                            <SelectItem value="st_elevation">
                              {t.ecg.sttChangesOptions.st_elevation}
                            </SelectItem>
                            <SelectItem value="t_wave_inversion">
                              {t.ecg.sttChangesOptions.t_wave_inversion}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="number" placeholder="ms" {...field} />
                          </FormControl>
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder={t.ecg.qtcMethodPlaceholder}
                              {...field}
                            />
                          </FormControl>
                        </FormItem>
                          ...
                          <FormControl>
                            ...
                            >
                              ...
                              <FormItem className="flex items-center space-x-2 space-y-0">
                                ...
                                <FormLabel className="font-normal">
                                  {t.ecg.artifactOptions.high}
                                </FormLabel>
                              </FormItem>
                            </RadioGroup>
                          </FormControl>
                          <FormDescription>
                            {t.ecg.artifactDescription}
                          </FormDescription>
                        </FormItem>
                      )}
                    />
              ...
              <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t.stethoscope.s1Intensity}</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t.stethoscope.s2Intensity}</FormLabel>
                        <FormControl>
                          ...
                          >
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue
                                  placeholder={
                                    t.stethoscope.murmurGradePlaceholder
                                  }
                                />
                              </SelectTrigger>
                            </FormControl>
                          ...
                          >
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue
                                  placeholder={
                                    t.stethoscope.murmurPositionPlaceholder
                                  }
                                />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
                              <SelectItem value="aortic">
                                {t.stethoscope.murmurPositionOptions.aortic}
                              </SelectItem>
                              <SelectItem value="pulmonic">
              ...
              <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <FormField
                    control={form.control}
                    name="arterialStiffness"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t.ppg.stiffness}</FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t.ppg.stiffnessPlaceholder}
                            {...field}
                          />
                        </FormControl>
                      </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center space-x-2 space-y-0">
                          ...
                          <FormLabel className="font-normal">
                            {t.ppg.abnormalPulseOptions.none}
                          </FormLabel>
                        </FormItem>
                      )}
                    />
        ...
        <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500 printable-area">
          <Card className="mt-8 w-full">
            <CardHeader>
              ...
              <CardDescription>{t.results.disclaimer}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <SectionCard
                  title={t.results.hfRisk.title}
                  icon={<ShieldAlert className="text-destructive" />}
                >
                  <ResultDisplayItem
                    label={t.results.hfRisk.risk}
                    value={`${result.analysis.heartFailureRisk.percentage}% (${result.analysis.heartFailureRisk.level})`}
                  />
                  <ResultDisplayItem
                    label={t.results.hfRisk.classification}
                    value={result.analysis.heartFailureClassification}
                  />
                </SectionCard>
                ...
                >
                  <ResultDisplayItem
                    label={t.results.summary.largeVessels}
                    value={result.analysis.overallSummary.largeVessels}
                  />
                  <ResultDisplayItem
                    label={t.results.summary.microcirculation}
                    value={result.analysis.overallSummary.microcirculation}
                  />
                  <ResultDisplayItem
                    label={t.results.summary.myocardial}
                    value={`EF = ${result.analysis.overallSummary.myocardialFunction.ef}% → ${result.analysis.overallSummary.myocardialFunction.summary}`}
                  />
                  <ResultDisplayItem
                    label={t.results.summary.valve}
                    value={result.analysis.overallSummary.valveCondition}
                  />
                  <ResultDisplayItem
                    label={t.results.summary.electrical}
                    value={result.analysis.overallSummary.electricalActivity}
                  />
                  <div className="pt-2">
                    <Badge
                      variant={
                        t.results.assessmentMap[
                          result.analysis.overallSummary.overallAssessment
                        ].variant
                      }
                    >
                      {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <SectionCard title={t.results.ecg.title} icon={<LineChart />}>
                  <ResultDisplayItem
                    label={t.results.ecg.abnormalHr}
                    value={result.analysis.ecgAbnormalities.abnormalHeartRate}
                  />
                  <ResultDisplayItem
                    label={t.results.ecg.detectedRhythm}
                    value={result.analysis.ecgAbnormalities.detectedRhythm}
                  />
                  <p className="font-medium text-foreground pt-2">
                    {t.results.ecg.conduction.title}
                  </p>
                  <ResultDisplayItem
                    label={t.results.ecg.conduction.pr}
                    value={`${result.analysis.ecgAbnormalities.conductionAbnormality.prInterval} ms`}
                    sub
                  />
                  <ResultDisplayItem
                    label={t.results.ecg.conduction.qrs}
                    value={`${result.analysis.ecgAbnormalities.conductionAbnormality.qrsDuration} ms`}
                    sub
                  />
                  <ResultDisplayItem
                    label={t.results.ecg.conduction.qt}
                    value={`${result.analysis.ecgAbnormalities.conductionAbnormality.qtQtcProlongation} ms`}
                    sub
                  />
                  <ResultDisplayItem
                    label={t.results.ecg.stt}
                    value={result.analysis.ecgAbnormalities.sttAbnormalities}
                  />
                  <p className="font-medium text-foreground pt-2">
                    {t.results.ecg.ectopy.title}
                  </p>
                  <ResultDisplayItem
                    label={t.results.ecg.ectopy.pvc}
                    value={`${result.analysis.ecgAbnormalities.ectopyArrhythmiaRisk.pvcBurden}%`}
                    sub
                  />
                  <ResultDisplayItem
                    label={t.results.ecg.ectopy.pac}
                    value={`${result.analysis.ecgAbnormalities.ectopyArrhythmiaRisk.pacBurden}%`}
                    sub
                  />
                  <ResultDisplayItem
                    label={t.results.ecg.ectopy.couplet}
                    value={
                      result.analysis.ecgAbnormalities.ectopyArrhythmiaRisk
                        .coupletTriplet
                    }
                    sub
                  />
                  <ResultDisplayItem
                    label={t.results.ecg.ectopy.vt}
                    value={
                      result.analysis.ecgAbnormalities.ectopyArrhythmiaRisk
                        .nonSustainedVT
                    }
                ...
                <SectionCard
                  title={t.results.stethoscope.title}
                  icon={<Stethoscope />}
                >
                  <ResultDisplayItem
                    label={t.results.stethoscope.abnormalSound}
                    value={
                      result.analysis.stethoscopeAbnormalities
                        .abnormalHeartSound
                    }
                  />
                  {result.analysis.stethoscopeAbnormalities.murmur.detected ? (
                    <>
                      <p className="font-medium text-foreground pt-2">
                        {t.results.stethoscope.murmur.title}
                      </p>
                      <ResultDisplayItem
                        label={t.results.stethoscope.murmur.type}
                        value={
                          result.analysis.stethoscopeAbnormalities.murmur.type
                        }
                        sub
                      />
                      <ResultDisplayItem
                        label={t.results.stethoscope.murmur.position}
                        value={
                          result.analysis.stethoscopeAbnormalities.murmur
                            .position
                        }
                        sub
                      />
                      <ResultDisplayItem
                        label={t.results.stethoscope.murmur.grade}
                        value={
                          result.analysis.stethoscopeAbnormalities.murmur.grade
                        }
                        sub
                      />
                    </>
                    ...
                    <ResultDisplayItem
                      label={t.results.stethoscope.murmur.title}
                      value={t.results.stethoscope.murmur.notDetected}
                    />
                  )}
                  <ResultDisplayItem
                    label={t.results.stethoscope.extraSounds}
                    value={
                      result.analysis.stethoscopeAbnormalities.extraSounds.join(
                        ", "
                      ) || t.results.none
                    }
                  />
                  <p className="font-medium text-foreground pt-2">
                    {t.results.stethoscope.otherFindings.title}
                  </p>
                  <ResultDisplayItem
                    label={t.results.stethoscope.otherFindings.clickSnap}
                    value={
                      result.analysis.stethoscopeAbnormalities
                        .otherAcousticFindings.clickSnap
                    }
                    sub
                  />
                  <ResultDisplayItem
                    label={t.results.stethoscope.otherFindings.frictionRub}
                    value={
                      result.analysis.stethoscopeAbnormalities
                        .otherAcousticFindings.frictionRub
                    }
                    sub
                  />
                </SectionCard>
                ...
                <SectionCard title={t.results.ppg.title} icon={<Waves />}>
                  {result.analysis.ppgAbnormalities.hasAbnormality ? (
                    <>
                      {result.analysis.ppgAbnormalities.arrhythmia && (
                        <ResultDisplayItem
                          label={t.results.ppg.arrhythmia}
                          value={`HRV: ${result.analysis.ppgAbnormalities.hrv} ms`}
                        />
                      )}
                      {result.analysis.ppgAbnormalities.lowSpO2 && (
                        <ResultDisplayItem
                          label={t.results.ppg.lowSpo2}
                          value={`SpO₂: ${result.analysis.ppgAbnormalities.spO2}%`}
                        />
                      )}
                      {result.analysis.ppgAbnormalities.tachycardia && (
                        <ResultDisplayItem
                          label={t.results.ppg.tachycardia}
                          value={`HR: ${result.analysis.ppgAbnormalities.heartRate} bpm`}
                        />
                      )}
                      {result.analysis.ppgAbnormalities.bradycardia && (
                        <ResultDisplayItem
                          label={t.results.ppg.bradycardia}
                          value={`HR: ${result.analysis.ppgAbnormalities.heartRate} bpm`}
                        />
                      )}
                      {result.analysis.ppgAbnormalities.highArterialStiffness && (
                        <ResultDisplayItem
                          label={t.results.ppg.stiffness}
                          value={t.results.high}
                        />
                      )}
